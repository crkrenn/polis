...
gulp.task("connect", [], function () {
  ...
  app.use(
    /^\/landerImages/,
    express.static(path.join("polisStatic", "landerImages"))
  );
  ...
  app.use(
    /^\/professors$/,
    express.static(path.join(destRootBase, "professors.html"))
  );
  app.use(/^\/news$/, express.static(path.join(destRootBase, "news.html")));
  app.use(
    /^\/pricing$/,
    express.static(path.join(destRootBase, "pricing.html"))
  );
  app.use(/^\/survey$/, express.static(path.join(destRootBase, "survey.html")));
  app.use(
    /^\/company$/,
    express.static(path.join(destRootBase, "company.html"))
  );
  app.use(/^\/docs\/api$/, function (req, res) {
    res.redirect("/docs/api/v3");
  });
  ...
  app.use(
    /^\/docs\/api\/v3$/,
    express.static(path.join(destRootBase, "api_v3.html"))
  );
  app.use(/^\/embed$/, express.static(path.join(destRootBase, "embed.html")));
  app.use(
    /^\/politics$/,
    express.static(path.join(destRootBase, "politics.html"))
  );
  app.use(
    /^\/marketers$/,
    express.static(path.join(destRootBase, "marketers.html"))
  );
  ...
  app.use(
    /^\/privacy$/,
    express.static(path.join(destRootBase, "privacy.html"))
  );
  app.use(
  ...
  app.use(
    /^\/billions$/,
    express.static(path.join(destRootBase, "billions.html"))
  );
...
gulp.task("css", function () {
  gulp
    .src([devMode ? "css/polis_main_devel.scss" : "css/polis_main_dist.scss"])
    .pipe(
      sass({
...
gulp.task("sparklines", function () {
  var s = gulp.src("sparklines.svg").pipe(gulp.dest(destRoot()));
});
...
gulp.task("templates", function () {
  ...
  return gulp
    .src(["js/templates/*.hbs", "js/templates/*.handlebars"])
    .pipe(
      tap(function (file) {
    ...
    .pipe(
      browserify({
        ...
        shim: {
          ...
          bootstrap_alert: {
            //all bootstrap files need to be added to the dependency array of js/main.js
            path:
              "node_modules/bootstrap-sass/assets/javascripts/bootstrap/alert",
            depends: { jquery: "jQuery" },
            exports: null,
          },
          bootstrap_tab: {
            path:
              "node_modules/bootstrap-sass/assets/javascripts/bootstrap/tab",
            depends: { jquery: "jQuery" },
            exports: null,
          },
          bootstrap_popover: {
            path:
              "node_modules/bootstrap-sass/assets/javascripts/bootstrap/popover",
            depends: { jquery: "jQuery" },
            exports: null,
          },
          bootstrap_collapse: {
            path:
              "node_modules/bootstrap-sass/assets/javascripts/bootstrap/collapse",
            depends: { jquery: "jQuery" },
            exports: null,
          },
          bootstrap_dropdown: {
            path:
              "node_modules/bootstrap-sass/assets/javascripts/bootstrap/dropdown",
            depends: { jquery: "jQuery" },
            exports: null,
          },
          bootstrap_affix: {
            path:
              "node_modules/bootstrap-sass/assets/javascripts/bootstrap/affix",
            depends: { jquery: "jQuery" },
            exports: null,
          },
          d3tooltips: {
          ...
          bootstrap_tooltip: {
            path:
              "node_modules/bootstrap-sass/assets/javascripts/bootstrap/tooltip",
            depends: { jquery: "jQuery" },
            exports: null,
          },
          bootstrap_button: {
            path:
              "node_modules/bootstrap-sass/assets/javascripts/bootstrap/button",
            depends: { jquery: "jQuery" },
            exports: null,
          },
          bootstrap_transition: {
            path:
              "node_modules/bootstrap-sass/assets/javascripts/bootstrap/transition",
            depends: { jquery: "jQuery" },
            exports: null,
          },
          deepcopy: {
...
gulp.task("scriptsOther", function () {
  ...
  if (!devMode) {
    s = s.pipe(uglify()).pipe(gzip()).pipe(renameToRemoveGzExtention());
  }
  return s.pipe(gulp.dest(destRoot() + "/js"));
});
...
gulp.task(
  "deployPreprodUnminified",
  ["preprodConfig", "unminifiedConfig", "dist"],
  doUpload
);

gulp.task("deploySurvey", ["prodConfig", "dist"], function () {
    ...
    let oo = _.extend(
      {
        ...
        makeUploadPath: function (file) {
          ...
          let fixed =
            _.isString(o.subdir) && match && match[0]
              ? match[0]
  ...
  promises.push(
    deployBatch({
      ...
      logStatement: function (file) {
        console.log(
          "upload path cached_embedJs_" + embedJsCacheSeconds + " /embed.js"
        );
        return "/embed.js";
      },
      subdir: null,
  ...
  promises.push(
    deployBatch({
      ...
      headers: {
        ...
        "Cache-Control": "no-cache".replace(
          /MAX_AGE/g,
          twitterAuthReturnCacheSeconds
        ),
      },
      logStatement: function (file) {
...
gulp.task("default", ["dev", "watchForDev"], function () {});
